...
<head>
  ...
  <meta name="description" content="Aplikasi Stok Obat">
  <meta name="author" content="USACA" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <span style="font-size:30px;font-weight:600px;"><b><i>Book Store</i></b></span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <script>document.write(new Date().getFullYear())</script> - Book Store</strong>
      </footer>
    </div>
