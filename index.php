...
<head>
  ...
  <meta name="author" content="Deryl" />
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      <div style="color:#3c8dbc" class="login-logo"> 
        <b>Book Store</b>
        <p style="font-size: 12px;"><b><i>Manajemen Stok Buku</i></b></p>
      </div>
      <form action="login-check.php" method="POST">
        ...
        <div class="row">
          <div class="col-xs-4 pull-right">
            <input type="submit" class="btn btn-primary btn-md btn-block" name="login" value="Login" />
          </div>
        </div>
      </form>
